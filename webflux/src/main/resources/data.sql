...
insert into users(name, surname, username, email,password) values('Daniel2', 'Marcus2', 'user12', 'user@gmail.com', 'password123')
insert into users(name, surname, username, email,password) values('Daniel3', 'Marcus3', 'user12', 'user@gmail.com', 'password123')
